<div class="side-bar">
            ...
            <div class="bar-content">
                ...
                <div class="sub-menu">
                    <ul class="nav-sb">
                        <li><a href="./Tongquan.php" class="active"><span class="box-cont"><i class="fas fa-tachometer-alt"></i></span><span>Tổng quan</span></a></li> 
                        <li><a href="#!" ><span class="box-cont"><i class="fas fa-users"></i></span><span>Nhóm người dùng</span> <i class="fas fa-angle-left"></i></a>
                            <ul class="ele-sub" >
                        ...
                        <li><a href="#!"><span class="box-cont"><i class="fas fa-user"></i></span><span>Quản lý người dùng</span><i class="fas fa-angle-left"></i></a>
                            <ul class="ele-sub">
                        ...
                        <li><a href="#!"><span class="box-cont"><i class="fas fa-tshirt"></i></span><span>Quản lý sản phẩm</span><i class="fas fa-angle-left"></i></a>
                            <ul class="ele-sub">
                        ...
                        <li><a href="#!"><span class="box-cont"><i class="fa-solid fa-warehouse"></i></span><span>Quản lý nhà cung cấp</span><i class="fas fa-angle-left"></i></a>
                            <ul class="ele-sub">
                        ...
                        <li><a href="#!"><span class="box-cont"><i class="fa-solid fa-money-bill"></i></span><span>Quản lý thanh toán</span><i class="fas fa-angle-left"></i></a>
                            <ul class="ele-sub">
                        ...
                        <li><a href="#!"><span class="box-cont"><i class="fa-solid fa-truck-fast"></i></span><span>Quản lý vận chuyển</span><i class="fas fa-angle-left"></i></a>
                            <ul class="ele-sub">
                                <li><a href="#!"><span class="box-cont"><i class="far fa-circle"></i></span><span>Danh sách</span></a></li>
                                <li><a href="#!"><span class="box-cont"><i class="far fa-circle"></i></span><span>Thêm mới</span></a></li>
                            </ul>
                        </li>
                        <li><a href="#!"><span class="box-cont"><i class="fas fa-file-invoice-dollar"></i></span><span>Quản lý hóa đơn</span><i class="fas fa-angle-left"></i></a>
                            <ul class="ele-sub">
                        ...
                        <li><a href="#!"><span class="box-cont"><i class="fas fa-phone-alt"></i></span><span>Quản lý liên hệ</span><i class="fas fa-angle-left"></i></a>
                            <ul class="ele-sub">
