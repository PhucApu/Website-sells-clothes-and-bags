...
async function addProduct(event) {
    ...
    if (type === 'tui-xach') {
        let productCode = document.querySelector('#addFormBag #productCode').value.toUpperCase();
        let nameProduct = document.querySelector('#addFormBag #nameProduct').value.trim();
        let supplierCode = document.querySelector('#addFormBag #supplierCode').value.trim();
        ...
        let description = document.querySelector('#addFormBag #describeProduct').value.trim();
        ...
        let target = document.querySelector('#addFormBag #targetGender').value.trim();
        let promotion = document.querySelector('#addFormBag #promotion').value.trim();
        let bagMaterial = document.querySelector('#addFormBag #bagMaterial').value.trim();
        let descriptionMaterial = document.querySelector('#addFormBag #descriptionMaterial').value.trim();
        ...
        if (checkNumber(promotion, "Khuyến mãi phải lớn hơn hoặc bằng 0") == false) {
            isValidate = false;
            return;
        }
        // else {
        if (isValidate == true) {
            try {
                ...
                const response = await fetch('../../../BLL/ProductBLL.php', {
                    ...
                    body: 'function=' + encodeURIComponent('addHandBagProduct') + '&productCode=' + encodeURIComponent(productCode) +
                        ...
                        '&arrImg=' + encodeURIComponent(JSON.stringify(image)) + '&descriptionMaterial=' + encodeURIComponent(descriptionMaterial)
                });
    ...
    // Thêm sản phẩm quan ao
        ...
        let productCode = document.querySelector('#addFormShirt #productCode').value.toUpperCase();
        let nameProduct = document.querySelector('#addFormShirt #nameProduct').value.trim();
        let supplierCode = document.querySelector('#addFormShirt #supplierCode').value.trim();
        let price = document.querySelector('#addFormShirt #price').value.trim();
        let shirtStyle = document.querySelector('#addFormShirt #shirtStyle').value.trim();
        let description = document.querySelector('#addFormShirt #describeProduct').value.trim();
        ...
        let target = document.querySelector('#addFormShirt #targetGender').value.trim();
        let promotion = document.querySelector('#addFormShirt #promotion').value.trim();
        let shirtMaterial = document.querySelector('#addFormShirt #shirtMaterial').value.trim();
        let descriptionMaterial = document.querySelector('#addFormShirt #descriptionMaterial').value.trim();
        let isValidate = true;
        let sumQuantity = 0;
        let sizes = []; //Mang size
        ...
        let sizesString = sizes.map(size => `${size.size}-${productCode}-${size.quantity}`).join('_');
        ...
        if (isValidate == true) {
            try {
                const response = await fetch('../../../BLL/ProductBLL.php', {
                    ...
                    body: 'function=' + encodeURIComponent('addShirtProduct') + '&productCode=' + encodeURIComponent(productCode) +
                        '&nameProduct=' + encodeURIComponent(nameProduct) + '&supplierCode=' + encodeURIComponent(supplierCode) +
...
document.getElementById('productCode').addEventListener('keypress', function (event) {
